...
import { cartUrl } from "../../../lib/constants/carousel/uri";
 ...
 return (
  <>
   <Popover>
    ...
    <PopoverContent align="center" sideOffset={9} className="p-0 w-56 sm:w-[350px]">
     <div className="flex flex-col items-center justify-center p-3 sm:p-6">
      ...
      <button className="px-4 sm:px-6 py-1.5 sm:py-2 border border-green-500 text-green-600 rounded-md font-semibold hover:bg-green-50 transition text-xs sm:text-base">
       Mulai Belanja
      </button>
     </div>
    </PopoverContent>
