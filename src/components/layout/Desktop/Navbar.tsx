...
import { logoUrl } from "../../../lib/constants/carousel/uri";
import CartPopover from "../../common/header-wrapper/cart-popover";
import Link from "next/link";
import { Button } from "@/components/ui/button";
import { SignedIn, SignedOut, UserButton } from "@clerk/nextjs";
import Address from "../../features/address/address";
import Email from "../../common/header-wrapper/mail";
    ...
    <nav className="w-full bg-white px-7 py-3 border-neutral-200">
     <div className="flex flex-row items-center justify-between w-full">
      ...
      <div className="flex items-center gap-2">
       ...
       <Link href="/sign-in">
        <Button
         className="font-semibold tracking-tight border border-green-600 text-green-600 hover:text-white hover:bg-green-600 px-4 py-2 text-sm transition-colors"
         variant="outline"
        >
         masuk
        </Button>
