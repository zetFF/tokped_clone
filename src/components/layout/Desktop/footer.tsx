...
import { footerLinks, securityBadges, socialMediaIcons, appBenefits } from "../../../lib/constants/footer/desktop-item";
...
const FooterDesktop = () => {
 return (
  <footer className="bg-white border-t border-gray-200 pt-10 pb-4 px-8 text-sm">
   ...
   {/* Copyright Section */}
   <div className="max-w-6xl mx-auto flex flex-col md:flex-row font-semibold justify-between items-center mt-8 border-t border-gray-200 pt-4 text-xs text-gray-500 gap-4">
